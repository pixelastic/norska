  ...
  describe('run', () => {
    ...
    describe('headers', () => {
      it.each([
        ...
        [
          '# We ♥ you',
          '<h1 id="we-love-you"><a href="#we-love-you">We ♥ you</a></h1>',
        ],
        [
          '# `require` **is** _important_',
          '<h1 id="require-is-important"><a href="#require-is-important"><code>require</code> <strong>is</strong> <em>important</em></a></h1>',
        ],
